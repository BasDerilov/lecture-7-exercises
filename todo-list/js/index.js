...
const createTaskTitleElement = document.getElementById("task-title-creator");
const createTaskContentElement = document.getElementById("task-content-creator");
...
createBtn.addEventListener("click", () => {
    cardContainer.appendChild(new TaskCard(createTaskTitleElement.value, createTaskContentElement.value));
});
